export function About() {
  return (
    <section id="about" className="relative bg-paper py-28 md:py-40 px-6 md:px-10">
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-7 md:col-start-6 space-y-6 text-lg md:text-xl leading-relaxed text-ink/85">
          <p>
            ...
            tools for healthcare — from surgical simulators to molecular
            visualization, from anatomy ed to clinical empathy training.
          </p>
          <p>
            We host workshops on Unity and WebXR, run faculty-paired research
            projects with the David Geffen School of Medicine, and ship demos
            you can actually put on your face.
          </p>
